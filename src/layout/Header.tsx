...
const Header = (): JSX.Element => {
  ...
  useEffect(() => {
    const sessionTheme = window.sessionStorage.getItem(THEME) as themeType;
  ...
  useEffect(() => {
    document.querySelector("html")?.setAttribute("data-theme", themeState);
    window.sessionStorage.setItem(THEME, themeState);
  ...
  return (
    <div className="w-screen flex justify-center items-center">
      <div className="w-4/5 flex justify-between items-center p-8 py-20">
        <Link to={"/"}>
          <svg
