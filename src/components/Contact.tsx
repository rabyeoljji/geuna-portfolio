      ...
      >
        <div className="card w-80 h-[26rem] bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <p>https://github.com/rabyeoljji</p>
            <div className="card-actions justify-center mt-4">
              <button className="btn btn-neutral">Go To Github</button>
            </div>
          </div>
        </div>
        <div className="card w-80 h-[26rem] bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <p>https://velog.io/@rabyeoljji/series</p>
            <div className="card-actions justify-center mt-4">
              <button className="btn btn-neutral">Go To Blog</button>
            </div>
          </div>
        </div>
        <div className="card w-80 h-[26rem] bg-base-100 shadow-xl">
